  ...
  return (
    <div className="space-y-10">
      <div className="flex gap-10 justify-between">
        <GalleryItem src={image} text="Image 1" style="w-[35%]" />
        <GalleryItem src={image} text="Image 2" style="w-[65%]" />
      </div>
      <div className="flex gap-10 justify-between">
        <GalleryItem src={image} text="Image 3" style="w-[100%]" />
      </div>
      <div className="flex gap-10 justify-between">
        <GalleryItem src={image} text="Image 4" style="w-[50%]" />
        <GalleryItem src={image} text="Image 5" style="w-[50%]" />
      </div>
    </div>
  );
};
